...
public class ExplorecaliApplication implements CommandLineRunner {
	...
	///************* Adding tours to our in memory DB when the app starts up - Since data is erased in shutdown
	...
	// Runs on Start - Implemented from CommandLineRunner - Creates tours on start up
	@Override
     ...
     * Not all fields in JSON are 1-1 to our class - so helper helps
	 */
